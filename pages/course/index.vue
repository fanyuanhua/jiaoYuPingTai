              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    <img :src="item.cover" class="img-responsive" :alt="item.title" style="width: 267px;height: 167px">
                    <div class="cc-mask">
                      <!-- <a :href="'/course/'+item.id" title="开始学习" class="comm-btn c-btn-1">开始学习</a> -->
                      <router-link :to="'/course/'+item.id" title="开始学习" class="comm-btn c-btn-1">开始学习</router-link>
                    </div>
                  </section>
