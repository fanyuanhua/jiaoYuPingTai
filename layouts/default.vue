  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="在线教育">
            <img src="~/assets/img/tou.png" width="100%" style="transform:scale(0.6) translateY(-45px)" alt="在线教育">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
...
export default {
  ...
  created() {
    ...
    // this.token = JSON.stringify(this.$route.query.token)
